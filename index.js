...
console.log("assignment 1:"  + createMenuItem(latte))
...
*/
const pizza = createMenuItem('pizza', 5, 'Junk Food');
const chilli = createMenuItem('chilli', 7, 'Snack');
const nachos = createMenuItem('nachos', 6, 'snacks');
console.log(pizza);
console.log(chilli);
console.log(nachos);
...
Using the burger object below do the following:
  ...
  3. Depending on the string, it will return the corr`ect discounted price
...
const burger = {
  ...
  price: 18, 
  category: "Lunch",  
discount : function calculateDiscount(person){
